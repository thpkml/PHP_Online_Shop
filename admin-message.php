<?php
	...
	$toid = $_POST['toid']; //from form on adminhome page
...
// Get admin details from database
	$sql = "SELECT * FROM admin WHERE id=" .$toid;
	...
	$sql2 = "SELECT * FROM admin WHERE id=" .$fromid;
...
<div id="adminmessage">
	<form action="<?php echo ($_SERVER['PHP_SELF']); ?>" method="POST">
		...
		<label>From: <input type="text" name="from" value="<?php echo $firstname2 ." ".$lastname2; ?>"></label>
		<input type="hidden" name="receiverid" value="<?php echo $toid; ?>">
		<label>To: <input type="text" name="to" value="<?php echo $firstname ." ".$lastname; ?>"></label><br>
		<label>Subject: <input type="text" name="subject" maxlength="200"required></label><br>
		<label>Message: <br><textarea name="message" style="width:50em; height:20em;" maxlength="1000"required></textarea></label><br>
